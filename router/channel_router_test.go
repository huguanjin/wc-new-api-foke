...
func TestChannelCreateAndTestRoutesUseDedicatedPermissions(t *testing.T) {
	assertChannelRoutePermission(t, http.MethodPost, "/", authz.ChannelCreate, controller.AddChannel)
