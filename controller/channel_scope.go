...
// maskChannelNamesForReadonly clears channel names for readonly admins.
func maskChannelNamesForReadonly(c *gin.Context, channels ...*model.Channel) {
	if c.GetInt("role") != common.RoleReadonlyAdmin {
		return
	}
